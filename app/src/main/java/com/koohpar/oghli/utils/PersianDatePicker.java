...
public class PersianDatePicker extends LinearLayout {
    ...
    public PersianDatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        yearRange = a.getInteger(R.styleable.PersianDatePicker_yearRange, 90);
        ...
        monthNumberPicker.setValue(selectedMonth+1);
...
//        return displayPersianDate;
        return yearNumberPicker.getValue()+"/"+monthNumberPicker.getValue()+"/"+dayNumberPicker.getValue();
    }

    public String getDisplayDateWithOutCharacter() {
        String year = String.valueOf(yearNumberPicker.getValue());
        String month = String.valueOf(monthNumberPicker.getValue());
        String day = String.valueOf(dayNumberPicker.getValue());
        if(month.length()<2)
    ...
    public void setDisplayPersianDate(PersianCalendar displayPersianDate) {
        ...
        monthNumberPicker.setValue(month+1);
        dayNumberPicker.setValue(day);
    }
